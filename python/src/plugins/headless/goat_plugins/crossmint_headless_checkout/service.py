...
class CrossmintHeadlessCheckoutService:
    ...
    async def buy_token(self, wallet_client: WalletClientBase, parameters: dict):
        ...
        try:
            ...
            if self._is_solana_blockchain(payment_method):
    ...
    def _is_solana_blockchain(self, method: str) -> bool:
        """Check if the payment method is a Solana blockchain."""
        solana_chains = ["solana", "solana-devnet", "solana-testnet"]
        return method in solana_chains
