...
# Send and receive tokens on Soneium
## 🚀 Quickstart
...
```bash
cd examples/by-use-case/soneium-send-and-receive-tokens
```
...
5. Make sure your wallet has Soneium ETH to perform transactions on the network.
