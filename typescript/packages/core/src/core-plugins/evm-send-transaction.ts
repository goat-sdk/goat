            ...
            return [
                {
                    ...
                    description:
                        "This {{tool}} signs and sends an EVM transaction.",
                    parameters: EVMSendTransactionSchema,
                    method: (
                        parameters: z.infer<typeof EVMSendTransactionSchema>
                    ) => {
                        return evmSendTransactionMethod(
                            walletClient,
                            parameters
                        );
                    },
...
export const EVMSendTransactionSchema = z.object({
    ...
    options: z.object({
        ...
        }).optional().describe("The paymaster info for the transaction"),
    }).optional().describe("The options for the transaction"),
});
